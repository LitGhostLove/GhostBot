...
`.award` | Awards someone a certain amount of currency. You can specify the reason after the mention. You can also specify a role name to award currency to all users in a role. **Bot owner only** | `.award 100 @person` or `.award 5 Role Of Gamblers`
